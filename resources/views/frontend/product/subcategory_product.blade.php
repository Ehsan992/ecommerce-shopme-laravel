            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-9">
                    <div class="shop-product-fillter">
                        @php
                        $productCount = \App\Models\Product::where('subcategory_id', $subcategory->id)->count();
                        @endphp
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop-grid-right.html">{{ $subcategory->subcategory_name }}</a>
                                        </div>
                    ...
                    <div class="widget-area">
                        ...
                        <div class="sidebar-widget widget_categories mb-30 p-30 bg-grey border-radius-10">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title mb-10">Child Categories</h5>
                            ...
                            <div class="">
                                <ul class="categor-list">
                                    ...
                                    @php
                                    $productCount = \App\Models\Product::where('childcategory_id', $row->id)->count();
                                    @endphp
                                    <li class="cat-item text-muted"><a href="{{ route('childcategorywise.product',$row->id) }}">{{ substr($row->childcategory_name,0,25) }}</a>({{ $productCount }})</li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
