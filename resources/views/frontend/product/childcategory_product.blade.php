    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="{{ route('categorywise.product',$parent_category->parent_category_id) }}">{{ $parent_category->parent_category_name }}</a>
                <span></span> <a href="{{ route('subcategorywise.product',$parent_category2->parent_subcategory_id) }}">{{ $parent_category2->parent_subcategory_name }}</a>
                <span></span> {{ $childcategory->childcategory_name }}
            </div>
        </div>
    </div>
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-9">
                    <div class="shop-product-fillter">
                        @php
                        $productCount = \App\Models\Product::where('childcategory_id', $childcategory->id)->count();
                        @endphp
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="shop-grid-right.html">{{ $childcategory->childcategory_name }}</a>
                                        </div>
                        ...
                        <div class="sidebar-widget widget_categories mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="">
                                <ul class="categor-list">
                                    ...
                                    @endphp
                                    <li class="cat-item text-muted"><a href="{{ route('categorywise.product',$row->id) }}">{{ substr($row->category_name,0,25) }}</a>({{ $productCount }})</li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
