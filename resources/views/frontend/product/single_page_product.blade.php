                                    ...
                                    <form action="{{ route('add.to.cart.quickview') }}" method="post" id="add_to_cart">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                ...
                                                <ins><span class="text-brand">{{ $setting->currency }}{{ $product->selling_price }}</span></ins>
                                                @else
                                                <ins><span class="text-brand">{{ $setting->currency }}{{ $product->discount_price }}</span></ins>
                                                <ins><span class="old-price font-md ml-15">{{ $setting->currency }}{{ $product->selling_price }}</span></ins>
                                                <span class="save-price font-md color3 ml-15">{{ number_format((($product->selling_price - $product->discount_price) / $product->selling_price) * 100, 2) }}% Off</span>
                                                @endif
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <form class="form-contact comment_form" action="{{ route('store.review') }}" method="post" id="commentForm">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <textarea class="form-control w-100" name="input_text" id="comment" cols="30" rows="9" placeholder="Write Comment"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        @if(Auth::check())
                                                        <button type="submit" class="button button-contactForm" name="submit" value="Submit">Submit Review</button>
                                                        @else
                                    ...
                                    <div class="product-cart-wrap small hover-up">
                                        <div class="product-img-action-wrap">
                                            ...
                                            <div class="product-action-1">
                                                ...
                                                <a aria-label="Add To Wishlist" class="action-btn wishlist-action-btn small hover-up" href="#" data-id="{{ $row->id }}"> <i class="far fa-heart" tabindex="0"></i> </a>
